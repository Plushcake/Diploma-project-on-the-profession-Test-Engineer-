...
public class ButtonNewsSteps {
    ...
    //Выбор сообщения из списка для раскрытия дополнительной информации. В разделе News.
    ...
    //Двойное нажатие на сообщения для раскрытия дополнительной информации. В разделе News.
