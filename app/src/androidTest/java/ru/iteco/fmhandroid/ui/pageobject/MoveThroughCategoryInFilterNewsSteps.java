...
public class MoveThroughCategoryInFilterNewsSteps {

    public void moveThroughCategoryInFilterNews() {
        ...
        ViewInteraction moveThroughCategory2 =
                onView(withText("День рождения"))
                        .inRoot(RootMatchers.isPlatformPopup())
                        .perform(click());
        clickCategory2.check(matches(withText("День рождения")));
        ...
        ViewInteraction moveThroughCategory3 =
                onView(withText("Зарплата"))
                        .inRoot(RootMatchers.isPlatformPopup())
                        .perform(click());
        clickCategory3.check(matches(withText("Зарплата")));
        ...
        ViewInteraction moveThroughCategory4 =
                onView(withText("Профсоюз"))
                        .inRoot(RootMatchers.isPlatformPopup())
                        .perform(click());
        clickCategory4.check(matches(withText("Профсоюз")));
        ...
        ViewInteraction moveThroughCategory5 =
                onView(withText("Праздник"))
                        .inRoot(RootMatchers.isPlatformPopup())
                        .perform(click());
        clickCategory5.check(matches(withText("Праздник")));
        ...
        ViewInteraction moveThroughCategory6 =
                onView(withText("Массаж"))
                        .inRoot(RootMatchers.isPlatformPopup())
                        .perform(click());
        clickCategory6.check(matches(withText("Массаж")));
        ...
        ViewInteraction moveThroughCategory7 =
                onView(withText("Благодарность"))
                        .inRoot(RootMatchers.isPlatformPopup())
                        .perform(click());
        clickCategory7.check(matches(withText("Благодарность")));
        ...
        ViewInteraction moveThroughCategory8 =
                onView(withText("Нужна помощь"))
                        .inRoot(RootMatchers.isPlatformPopup())
                        .perform(click());
        clickCategory8.check(matches(withText("Нужна помощь")));
